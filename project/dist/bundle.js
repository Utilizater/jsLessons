...
__webpack_require__(/*! array-includes */ "./node_modules/array-includes/index.js");
...
var tabs = __webpack_require__(/*! ./parts/tabs.js */ "./src/parts/tabs.js"),
    ...
    scroll = __webpack_require__(/*! ./parts/scroll.js */ "./src/parts/scroll.js"),
    ...
    calculator = __webpack_require__(/*! ./parts/calculator.js */ "./src/parts/calculator.js");
...
form();
slider();
calculator(); //window.addEventListener('DOMContentLoaded', () => {
//});
...
function form() {
      ...
      return new _Promise(function (resolve, reject) {
        ...
        requesst.addEventListener('readystatechange', function () {
          if (requesst.readyState < 4) {
            ...
            statusMesaage.style.background = "url(".concat(message.success, ") no-repeat center");
            statusMesaage.style.marginTop = "10px";
          } else {
            statusMesaage.innerHTML = "";
            statusMesaage.style.height = "80px";
            statusMesaage.style.background = "url(".concat(message.failure, ") no-repeat center");
            statusMesaage.style.marginTop = "10px";
          }
        });
        requesst.send(data);
  ...
  secondForm.addEventListener('submit', function (event) {
    ...
    postData(formData).then(function () {
      ...
      for (var i = 0; i < secondFormInputs.length; i++) {
  ...
  for (var i = 0; i < more.length; i++) {
    more[i].addEventListener('click', function () {
      if (document.body.clientWidth < 900) {
        ...
        var modalAnimation = function modalAnimation() {
          if (+overlay.style.opacity != 1) overlay.style.opacity = +overlay.style.opacity + 0.1 + "";else clearInterval(z);
        };

        var z = setInterval(modalAnimation, 50);
      }
...
function scroll() {
  ...
  anchors.forEach(function (item) {
    var myStopInterval = function myStopInterval() {
    ...
    item.addEventListener('click', function (e) {
      ...
      if (item.href.includes("about")) var element = document.getElementById("about");else if (item.href.includes("photo")) var element = document.getElementById("photo");else if (item.href.includes("price")) var element = document.getElementById("price");else if (item.href.includes("contacts")) var element = document.getElementById("contacts");

      var myTimer = function myTimer() {
        var coordY = element.getBoundingClientRect().top;
        if (Math.abs(coordY) > 30 && coordY < 0) window.scrollBy(0, -30);
        if (Math.abs(coordY) > 30 && coordY > 0) window.scrollBy(0, 30);
...
function timer() {
  ...
  var setClock = function setClock(id, endtime) {
    ...
    var updateClock = function updateClock() {
      ...
      if ((t.hours + "").length == 1) hours.textContent = "0" + t.hours;else hours.textContent = t.hours;
      if ((t.minutes + "").length == 1) minutes.textContent = "0" + t.minutes;else minutes.textContent = t.minutes;
      if ((t.seconds + "").length == 1) seconds.textContent = "0" + t.seconds;else seconds.textContent = t.seconds;
      if (t.total <= 0) clearInterval(timeInteval);
    };

    var timeInteval = setInterval(updateClock, 1000);
  };
